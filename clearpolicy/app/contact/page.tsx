  ...
  return (
    <div className="grid grid-cols-1 gap-6">
      ...
      <section className="card p-6">
        ...
        <p className="mt-3 text-sm text-gray-700 dark:text-gray-300">LinkedIn: <a className="text-accent hover:underline" href="https://linkedin.com/in/pranilraichura" target="_blank" rel="noreferrer noopener">linkedin.com/in/pranilraichura</a></p>
      </section>
    </div>
  );
}
